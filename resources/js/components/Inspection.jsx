            ...
            <table className="min-w-full divide-y divide-gray-300">
                ...
                {data.map(component => (
                    <tr key={component.id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{component.grade !== null && component.grade !== undefined ? component.grade.name || component.grade.grade_type_id : 'loading'}</td>
                    </tr>
                ))}
